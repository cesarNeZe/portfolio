...
useEffect(()=>{
    const tween = 
    KUTE.fromTo('#blob1',{path:'#blob1'},{path:'#blob2'}, {repeat:999,duration:1000, yoyo:true})
    tween.start()
},[])
    ...
    <>
        <section>
            ...
            >
                ...
                {/* Hidden blob shape */}
                <g transform="translate(277.95030195334846 485.81679187386425)" style={{ visibility: "hidden" }}>
                    <path
                        id='blob2'
